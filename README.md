...
<p align="center"> <img src="T1.png" alt="Tarot for KOReader screenshot 1" width="45%"> <img src="T2.png" alt="Tarot for KOReader screenshot 2" width="45%"> </p>

## Features

* Tarot and Lenormand support
* Daily Card
* Hidden Card spread with a 4x4 grid
...
Unzip and copy the plugin folder to:

```text
koreader/plugins/
```

Then restart KOReader and open the plugin from the tools menu.
